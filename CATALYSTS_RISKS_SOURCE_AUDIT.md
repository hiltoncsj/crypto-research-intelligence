...
| Risk `TOKEN_UNLOCK`                                                                                                                                                                                                                                                                         | DefiLlama Unlocks (Pro), Tokenomist.ai, Messari                                                                            | Sim       | Sim                | **Não** (paga)     | Provável (mas não testado sem key)              | Provável                                            | Provável                                                               | Desconhecida                         | **NOT_IMPLEMENTED** (paywall)                                  |
| Catalyst `TOKEN_UNLOCK`                                                                                                                                                                                                                                                                     | idem acima                                                                                                                 | —         | —                  | Não                | —                                               | —                                                   | —                                                                      | —                                    | **NOT_IMPLEMENTED** (paywall)                                  |
| Catalyst `PROTOCOL_UPGRADE` / `MAINNET` / `TESTNET`                                                                                                                                                                                                                                         | GitHub Releases                                                                                                            | Sim       | Sim                | Sim (60 req/hr)    | **Não** — sem mapeamento projeto→repo           | Sim                                                 | Sim                                                                    | Alta por chamada, mas sem mapeamento | **NOT_IMPLEMENTED** (sem ID)                                   |
| Catalyst `GOVERNANCE` / Risk `GOVERNANCE`                                                                                                                                                                                                                                                   | Snapshot.org GraphQL                                                                                                       | Sim       | Sim                | Sim                | **Não** — sem mapeamento projeto→space          | Sim                                                 | Sim                                                                    | Alta por chamada, mas sem mapeamento | **NOT_IMPLEMENTED** (sem ID)                                   |
...
5. **`TOKEN_UNLOCK`** — não recomendado para agora: única fonte adequada é paga (DefiLlama Pro
   a US$300/mês, ou equivalentes). Reavaliar somente se o usuário aprovar orçamento explícito —
   não implementar com dado sintético/estimado sob nenhuma circunstância, consistente com a
   política já em vigor desde o Sprint 13 para as dimensões de Tokenomics.
