...
| Catalyst `PROTOCOL_UPGRADE` / `MAINNET` / `TESTNET`                                                                                                                                                                                                                                         | GitHub Releases                                                                                                            | Sim       | Sim                | Sim (60 req/hr)    | **Sim, desde o Sprint 19** — `Project.githubRepo` curado manualmente    | Sim                                                 | Sim                                                                    | Alta por chamada                  | **PARCIALMENTE IMPLEMENTADO** (Sprint 19): GitHub Releases ativo como Catalyst `OTHER` sempre — as sub-categorias `PROTOCOL_UPGRADE`/`MAINNET`/`TESTNET` especificamente seguem `NOT_IMPLEMENTED` (exigiriam interpretar texto do release, proibido). Ver `EXTERNAL_IDENTITY_ARCHITECTURE.md`. |
