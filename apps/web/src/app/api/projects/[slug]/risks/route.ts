...
import { getRisks } from "@crypto-research/research-engine";

// Sprint 15 (Parte 27) — GET /api/projects/[slug]/risks. Mesmo padrão de rota fina.
export async function GET(_request: Request, context: { params: { slug: string } }) {
  ...
  const risks = await getRisks(project.id);
